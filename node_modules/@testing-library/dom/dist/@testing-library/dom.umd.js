(function (global, factory) {
  ...
  */
  ...
  function _runWithRealTimers(callback) {
    ...
    var usedJestFakeTimers = Object.entries(timerAPI).some(function (_ref) {
      var name = _ref[0],
          func = _ref[1];
    ...
    return {
      ...
      usedJestFakeTimers: usedJestFakeTimers
    };
  }

  var jestFakeTimersAreEnabled = function jestFakeTimersAreEnabled() {
    return Boolean(_runWithRealTimers(function () {}).usedJestFakeTimers);
  ...
  var _runWithRealTimers2 = runWithRealTimers(getTimeFunctions),
      clearTimeoutFn = _runWithRealTimers2.clearTimeoutFn,
      setImmediateFn = _runWithRealTimers2.setImmediateFn,
      setTimeoutFn = _runWithRealTimers2.setTimeoutFn;
  ...
  */
  ...
  var forEach_1 = function forEach_1(it) {
    var own = it.forEach;
    return it === ArrayPrototype$2 || it instanceof Array && own === ArrayPrototype$2.forEach // eslint-disable-next-line no-prototype-builtins -- safe
  ...
  var keys_1 = function keys_1(it) {
    var own = it.keys;
    return it === ArrayPrototype$6 || it instanceof Array && own === ArrayPrototype$6.keys // eslint-disable-next-line no-prototype-builtins -- safe

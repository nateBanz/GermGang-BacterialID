 ...
 */
export declare function localStoreAcknowledgeBatch(localStore: LocalStore, batchResult: MutationBatchResult): Promise<MaybeDocumentMap>;
/**
 ...
 * @returns The resulting modified documents.
 */
export declare function localStoreRejectBatch(localStore: LocalStore, batchId: BatchId): Promise<MaybeDocumentMap>;
/**
 ...
 * queue.
 */
export declare function localStoreApplyRemoteEventToLocalCache(localStore: LocalStore, remoteEvent: RemoteEvent): Promise<MaybeDocumentMap>;
/**
 ...
 */
export declare function localStoreReadDocument(localStore: LocalStore, key: DocumentKey): Promise<MaybeDocument | null>;
/**
...
export declare function localStoreLookupMutationDocuments(localStore: LocalStore, batchId: BatchId): Promise<MaybeDocumentMap | null>;
 ...
 */
export declare function localStoreGetNewDocumentChanges(localStore: LocalStore): Promise<MaybeDocumentMap>;
/**
 ...
 * queue.
 */
export declare function localStoreApplyBundledDocuments(localStore: LocalStore, bundleConverter: BundleConverter, documents: BundledDocuments, bundleName: string): Promise<MaybeDocumentMap>;
/**

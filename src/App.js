...
function App() {
  ...
  let gramPositiveAerobic = [
    {
      name: "Homepage 0000",
      image:
        "kisspng-computer-icons-home-clip-art-black-home-icon-5ab0be31073f68.5448178115215324650297.jpg",
      buttonList: ["Gram Positive 0000", "Gram Negative 0000"],
    },
...

    {
      ...
      image:
        "kisspng-computer-icons-home-clip-art-black-home-icon-5ab0be31073f68.5448178115215324650297.jpg",
      buttonList: [
        "Non-motile, non-hemolytic 0001",
        "Non-motile, hemolytic 0000",
      ],
    },
...

    {
      ...
      image:
        "kisspng-computer-icons-home-clip-art-black-home-icon-5ab0be31073f68.5448178115215324650297.jpg",
      buttonList: [
        "Cocci pairs and chains 0000",
        "Cocci clusters and tetrads 0000",
      ],
    },
...

    {
      ...
      image: "",
      buttonList: [
        "Alpha or Gamma-Hemolytic Streptococci Gram(+) cocci pairs & chains 0000",
        "Beta-Hemolytic Streptococci Gram(+) cocci pairs and chains 0000",
      ],
    },
...

    {
      ...
      image: "",
      buttonList: [
        "Slide Coagulase(+) 0000",
        "Slide Coagulase(+) but clumpy. Colony more white; non-hemolytic on day 1 0000",
        "Slide Coagulase(-) 0000",
      ],
    },
...

    {
      ...
      image: "",
      buttonList: [
        "Caramel, burnt sugar, or butterscotch smell**. Can have Group A, C, G, or F antigen. 0000",
      ],
    },
...

    {
      ...
      image: "",
      buttonList: [
        "Caramel, burnt sugar, or butterscotch smell**. Can have Group A, C, G, or F antigen. 0001",
      ],
    },
  ...
  let gramNegativeMac = [
    ...
    { name: "Lactose(+) 0000", image: "", buttonList: ["Indole 0000"] },

    { name: "Indole 0000", image: "", buttonList: ["(-) 0000", "(+) 0000"] },
...

    {
      ...
      image: "image",
      buttonList: [
        "Enterobacter, Providencia, Citrobacter, Cronobacter, Others 0000",
      ],
    },
...

    {
      ...
      image: "",
      buttonList: [
        "Colony mucoid. Odor of fresh bread? 0001",
        "Non-Mucoid E.Coli 0000",
      ],
    },
    ...
    { name: "Klebsiella, Rare Enterobacter 0000", image: "", buttonList: [] },
...

    {
      ...
      image: "",
      buttonList: [
        "B. cepacia, B. pseudomallei, Pasteurella, Others (Refer to your laboratory's BT rule out charts 0000",
      ],
    },
...

    {
      ...
      image:
        "kisspng-computer-icons-home-clip-art-black-home-icon-5ab0be31073f68.5448178115215324650297.jpg",
      buttonList: [
        "Small non-hemolytic and small Gram(+) rods 0000",
        "Small beta-hemolytic, tiny Gram(+) rods 0000",
        "Large Gram(+) rods and large colony 0000",
      ],
    },
    { name: "Yes 0002", image: "", buttonList: ["P. aeruginosa 0000"] },
    ...
    { name: "P. aeruginosa 0000", image: "", buttonList: [] },
    ...
    { name: "No 0002", image: "", buttonList: ["Indole 0001"] },

    { name: "Indole 0001", image: "", buttonList: ["(-) 0001", "(+) 0001"] },

    {
      name: "(-) 0001",
      image: "",
      buttonList: [
        "Serratia, Citrobacter, Enterobacter, S. maltophilia, Acinetobacter, Others ~ B. mallei, Y. pestis (Refer to your laboratory's BT rule out charts 0000",
      ],
    },
    ...
    { name: "E.coli (Use E.coli ID Chart) 0000", image: "", buttonList: [] },

    { name: "Yes 0003", image: "", buttonList: ["Proteus spp. 0000"] },
...

    {
      ...
      image: "",
      buttonList: [
        "Possible Salmonella, Shigella, Yersinia enterocolitica, pathogenic E.Coli, or Proteus spp. 0000",
      ],
    },
    ...
    { name: "No 0003", image: "", buttonList: ["Indole 0002"] },

    { name: "Indole 0002", image: "", buttonList: ["(+) 0002", "(-) 0002"] },

    {
      name: "(+) 0002",
      image: "",
      buttonList: [
        "Potential pathogenic E.coli ~ See GNR Stool Pathogens Lactose Positive Flowchart and follow ID for E.coli 0000",
      ],
    },
...

    {
      ...
      image: "",
      buttonList: [
        "Refer to GNR Stool Pathogens Lactose Negative Flowchart 0000",
      ],
    },

    {
      ...
      image: "",
      buttonList: ["Lactose fermenter on MAC 0001"],
    },

    { name: "Yes 0004", image: "", buttonList: ["Proteus spp. 0000"] },
    ...
    { name: "None 0000", image: "", buttonList: ["Yellow Colonies on HE"] },
    ...
    { name: "Oxidase (+) 0002", image: "", buttonList: ["Possible Aeromonas"] },
